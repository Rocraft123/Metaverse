...
public class TrustedCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        if (args.length == 0) {
            sender.sendMessage(MetaversePlugin.prefix.append(
                    Component.text("Not enough arguments. /help to see all the commands").color(NamedTextColor.RED)));
            return true;
        }
